...
In the following we’ll use the insight theme (3 others are available:
...
To create a dodge barchart, if your data are in “wide” format, you can
use the following (otherwise you have to reshape your data in “long”
