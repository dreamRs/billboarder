...
{"x":{"bb_opts":{"interaction":{"inputType":{"touch":false}},"data":{"json":{"billboarder":[9],"ggiraph":[177],"officer":[43],"shinyWidgets":[44],"visNetwork":[169]},"type":"pie"},"pie":[],"color":{"pattern":["#FEE5D9","#FCAE91","#FB6A4A","#DE2D26","#A50F15"]}},"data":null},"evals":[],"jsHooks":[]}
```
