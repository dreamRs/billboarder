...
#' }
#' @source RTE (\url{https://odre.opendatasoft.com/explore/dataset/equilibre-national-mensuel-prod-conso-brute/})
"equilibre_mensuel"
...
#' }
#' @source RTE (\url{https://odre.opendatasoft.com/explore/dataset/prod-national-annuel-filiere/})
"prod_par_filiere"
